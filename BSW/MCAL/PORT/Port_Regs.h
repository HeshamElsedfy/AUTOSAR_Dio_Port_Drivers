...
/*SYSTEM Control CLK Register*/
#define SYSCTL_REGCGC2_REG        (*((volatile uint32 *)0x400FE108))
#define SYSCTL_REGCGC2_PORT_CLOCK_MASK 0x0000003F

/*SIZE of alternate function Value in Control Register in bits*/
#define AF_SIZE 0x04

/*GPIOLOCK Unlock Key*/
#define PORT_GPIOLOCK_KEY (0x4C4F434B)
